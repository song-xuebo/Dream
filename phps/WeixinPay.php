...
class WeixinPay {
  ...
  private function unifiedorder() {
    $url = 'http://www.hd512.com/pay/wxpay2/';//产品中心必改的
    $parameters = array(
	...
	'notify_url' => 'http://wx.huidait.cn/admin/wxpay/notify', //通知地址 确保外网能正常访问()
...
//      'out_trade_no' => '2018013106125348', //商户订单号
  ...
  public static  function xmlToArray($xml){
      ...
      $ret_data = simplexml_load_string($result);
      return json_decode($ret_data);
  }
  //微信小程序接口
